...
public class UiUtils {
    ...
    public static void showToast(String str) {
        if (mToast == null) {
            mToast = Toast.makeText(App.Companion.getApplication(), str, Toast.LENGTH_SHORT);
        }
        mToast.setText(str);
        mToast.show();
    }
    ...
    public static void showToastLong(String str) {
        if (mToast == null) {
            mToast = Toast.makeText(App.Companion.getApplication(), str, Toast.LENGTH_LONG);
        }
        mToast.setText(str);
        mToast.show();
    }
    ...
    public static Resources getResource1() {
        return App.Companion.getApplication().getResources();
    }
