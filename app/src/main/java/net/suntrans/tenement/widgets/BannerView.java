...
//        });
    ...
    private void initLinearPosition() {
        ...
        mLinearPosition.setPadding(getResources().getDimensionPixelSize(R.dimen.dimen_12dp), 0, 0, UiUtils.dip2px(4));
        ...
        if (viewList != null && viewList.size() != 0) {
            if (mLinearPosition.getChildCount() != viewSize) {
                ...
                for (int i = 0; i < diffCnt; i++) {
                    if (needAdd) {
                        ...
                        img.setBackgroundResource(R.drawable.indicator_un_sclected);
            ...
            for (int i = 0; i < mLinearPosition.getChildCount(); i++) {
                if (i == (curPos % viewSize)) {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.indicator_sclected);
                } else {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.indicator_un_sclected);
                }
            }
        }
    }
