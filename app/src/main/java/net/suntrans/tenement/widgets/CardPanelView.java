...
public class CardPanelView extends FrameLayout implements ISlidingUpPanel<CardPanelView> {
    ...
    public void setmCardPosition(int mCardPosition) {
        this.mCardPosition = mCardPosition;
    }
    ...
    public void setmPanelExpendedHeight(int mPanelExpendedHeight) {
        this.mPanelExpendedHeight = mPanelExpendedHeight;
    }

    public void setmPanelHeight(int mPanelHeight) {
        this.mPanelHeight = mPanelHeight;
    }

    public void setmPanelRealHeight(int mPanelRealHeight) {
        this.mPanelRealHeight = mPanelRealHeight;
    }

    public void setmSlideState(int mSlideState) {
